...
RUN: .venv311/bin/python stock_lateral_toolkit/extract_drive.py <route_glob> <out.npz>
e.g. ... extract_drive.py "/Volumes/RAID_6_HDD/OpenPilot Data/explorer_st_logs/stock/00000004--3d3385646d" \
       stock_lateral_toolkit/cache/stock_hiram_04.npz
(route_glob may point at the NAS mount — LogReader reads .zst straight off it.)
"""
import os, sys, glob, bisect, math, re
from concurrent.futures import ProcessPoolExecutor
import numpy as np

ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))   # repo root (toolkit lives one level down)
