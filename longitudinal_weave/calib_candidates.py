...
alternating config). beta_tau=0 => FPR; beta_tau>0 => power. HARD COST BOUND: reps<=400 fast.
  ...
  .venv311/bin/python longitudinal_weave/calib_candidates.py --reps 400 [--workers N]
"""
...
def main():
    ...
    ap.add_argument('--csv', default='longitudinal_weave/results/drive_longitudinal.csv')
