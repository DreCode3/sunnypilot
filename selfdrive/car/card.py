...
class Car:
  ...
  def __init__(self, CI=None, RI=None) -> None:
    ...
    if CI is None:
      ...
      # Use keyword args to skip num_pandas (added to opendbc get_car signature in upstream merge)
      # num_pandas defaults to 1 — correct for our single-panda Explorer ST setup
