...
RUN: PYTHONPATH=$PWD:$PWD/opendbc_repo .venv311/bin/python \
       retrospective_lateral/stock_compare/analyze_compare.py <corridor>
  corridor in {marietta, hiram}
"""
import sys, glob
import numpy as np
from scipy import signal as sig

CACHE = "/Users/dregilley/Documents/GitHub/sunnypilot/retrospective_lateral/stock_compare/cache"
DT = 0.05
